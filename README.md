...
The purpose of this project was to rid the previous dataset off this discrepancy and analyze the data to show if the information presented from an earlier analysis will be affected by this change.
